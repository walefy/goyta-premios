...
userRouter.get('/', jwtAuth(true), (req: Request, res: Response) => userController.findAll(req, res));
userRouter.get('/:id', jwtAuth(), (req: Request, res: Response) => userController.findById(req, res));
